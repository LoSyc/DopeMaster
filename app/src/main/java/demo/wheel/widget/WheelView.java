...
import demo.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Scrolling
	private demo.wheel.widget.WheelScroller scroller;
	...
	// Recycle
	private demo.wheel.widget.WheelRecycle recycle = new demo.wheel.widget.WheelRecycle(this);
	...
	private void initData(Context context) {
		scroller = new demo.wheel.widget.WheelScroller(getContext(), scrollingListener);
	}

	// Scrolling listener
	demo.wheel.widget.WheelScroller.ScrollingListener scrollingListener = new demo.wheel.widget.WheelScroller.ScrollingListener() {
		@Override
		...
		public void onJustify() {
			if (Math.abs(scrollingOffset) > demo.wheel.widget.WheelScroller.MIN_DELTA_FOR_SCROLLING) {
